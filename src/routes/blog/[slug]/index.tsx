          ...
          <article>
            <header class={post?.image ? "text-center" : ""}>
              ...
              {post.image ? (
                <img
                  src={post.image}
                  class="mx-auto mt-4 mb-6 max-w-full bg-gray-400 sm:rounded-md lg:max-w-6xl"
            ...
            <div
              class="prose-md prose-headings:font-heading prose-headings:leading-tighter container prose prose-lg mx-auto mt-8 max-w-3xl px-6 prose-headings:font-bold prose-headings:tracking-tighter prose-a:text-primary-600 prose-img:rounded-md prose-img:shadow-lg sm:px-6 lg:prose-xl"
